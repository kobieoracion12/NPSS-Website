...
<body>
    ...
    <div class="container-fluid">
        <h3 class="mt-3 ms-5" style="color: #146dac;">Career Opportunities</h3>
    ...
    <footer class="text-center text-lg-start text-white mt-3" style="background-color: #146dac; position: absolute; width: 100%; ">
        <!-- Grid container -->
