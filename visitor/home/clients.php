...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="col-xl-12">
            <div class="card m-4 border-0 bg-transparent">
                <div class="card-body bg-transparent">
                    <img src="../dist/assets/images/nar_clients1.jpg" alt="" class="img-fluid img-thumbnail mx-auto d-block" style=" object-fit: cover; " width="1000px;" height="500px;">
                </div>
            </div>
        </div>
