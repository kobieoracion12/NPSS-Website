...
<body>
    ...
    <!--  Main Content -->
    <div class="container-fluid">
    	<div class="bg-image" style="background-image: url('../dist/assets/images/power.jpg');height: 60vh; width: 100%; background-repeat: no-repeat; background-position: center; background-size: cover;">
	    </div>
      <h3 class="mt-3 ms-5" style="color: #146dac;">Contact Us</h3>
        ...
        <div class="col-xl-11 mx-auto">
          ...
          <div class="card" style="height: 20rem;">
            <div class="card-body">
              <div class="row p-4">
                <div class="col-lg-4">
                  <i class="fas fa-map-marker-alt fa-4x mb-2 d-flex justify-content-center" style="color: #146dac;"></i>
                  <h5 class="card-title text-center">ADDRESS</h5>
                    <p class="card-text text-center fs-5">Main Office: 811 Aurelio Hall, Stall A, Rizal St. Brgy. Zone II, Luisiana, Laguna Field Office: Unit 223 Ciannat Complex Building, Marcos Highway, Brgy. Mayamot, Antipolo City.</p>
                </div>
                <div class="col-lg-4">
                  <i class="fas fa-phone-volume fa-4x mb-2 d-flex justify-content-center" style="color: #146dac;"></i>
                  <h5 class="card-title text-center">CONTACT NUMBER</h5>
                    <p class="card-text text-center fs-5">Telephone number: (02) 531-5594.</p>
                </div>
                <div class="col-lg-4">
                  <i class="fas fa-envelope fa-4x mb-2 d-flex justify-content-center" style="color: #146dac;"></i>
                  <h5 class="card-title text-center">EMAIL US</h5>
                    <p class="card-text text-center fs-5">Email address: narpowersystem@pldtdsl.net</p>
                </div>
              </div>
            </div>
          </div>
