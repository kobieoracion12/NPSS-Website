...
<body>
    ...
    <!--  Main Content -->
    <div class="bg-image">
        <img src="../dist/assets/images/nar_bg.jpg" class="img-fluid" style="height: 60vh; width: 100%; background-repeat: no-repeat; ">
    </div>
    <div class="container-fluid">
                    ...
                    <div class="row p-2">
                        <div class="col-sm-4">
                            <div class="nav flex-column nav-pills nav-pills-tab" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                <a class="nav-link active show mb-1" id="v-pills-home-tab" data-bs-toggle="pill" href="#v-pills-predictive" role="tab" aria-controls="v-pills-home" aria-selected="true">
                                    Predictive & Prevent ive Testing of Substation Equipment</a>
                                <a class="nav-link mb-1" id="v-pills-profile-tab" data-bs-toggle="pill" href="#v-pills-thermo" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                                    Thermographic Scanning Inspection</a>
                                <a class="nav-link mb-1" id="v-pills-messages-tab" data-bs-toggle="pill" href="#v-pills-ultrasonic" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                                    Ultrasonic Detection Testing & Machinery Health Monitoring</a>
                                <a class="nav-link mb-1" id="v-pills-settings-tab" data-bs-toggle="pill" href="#v-pills-fault" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                                    Fault Investigation & Trouble Shooting</a>
                                <a class="nav-link mb-1" id="v-pills-settings-tab" data-bs-toggle="pill" href="#v-pills-power" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                                    Power Quality Audit</a>
                                <a class="nav-link mb-1" id="v-pills-settings-tab" data-bs-toggle="pill" href="#v-pills-system" role="tab" aria-controls="v-pills-settings" aria-selected="false">
