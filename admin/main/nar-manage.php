                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-md text-start">
                                                            <div class="modal-content">
                                                                <div class="modal-header py-3 px-4 border-bottom-0 d-block">
                                                                    ...
                                                                    <h4 class="modal-title" id="modal-title">Edit Document</h4>
                                                                </div>
                                                                    ...
                                                                    <form class="needs-validation" method="post" action="../../php/edit-docu.php" enctype="multipart/form-data" novalidate>
                                                                        ...
                                                                        <div class="row mt-4">
                                                                            <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                                                                <button type="submit" name="edit-docu2" class="btn btn-primary px-4 py-1 rounded rounded-3" id="btn-save-event">Edit File</button>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-md">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body mx-4">
                                                                    ...
                                                                    <p class="text-muted h5 text-center">Do you really want to delete these? This process cannot be undone.</p>
                                                                    <form class="needs-validation" method="post" action="../../php/delete-docu.php">
                                                                        ...
                                                                        <div class="row mt-4">
                                                                            <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                                                                <button name="del_three" type="submit" class="btn btn-danger px-4 py-1 rounded-pill">Delete</button>
                    ...
                    <div class="modal fade" id="add-client" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered modal-md">
                            <div class="modal-content">
                                <div class="modal-header py-3 px-4 border-bottom-0 d-block">
                                    <button type="button" class="btn-close float-end" data-bs-dismiss="modal" aria-label="Close"></button>
                                    <h4 class="modal-title" id="modal-title">Upload Document</h4>
                                </div>
                                ...
                                <div class="modal-body mx-3 pt-0">
                                    <form class="needs-validation" method="post" action="../../php/upload-document.php" enctype="multipart/form-data" novalidate>
                                        ...
                                        <div class="row mt-4 mb-2">
                                            <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                                <button type="submit" name="upload-client-docu" class="btn btn-primary px-4 py-1 rounded rounded-3" id="btn-save-event">Upload File</button>
                                                <button type="button" class="btn btn-white rounded  rounded-3 fw-bold px-4 py-1" data-bs-dismiss="modal">Cancel</button>
                                            </div>
                                        </div>
