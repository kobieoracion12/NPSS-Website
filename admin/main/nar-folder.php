           ...
           <?php include "../design/top-menu.php" ?>
            ...
            <div class="content-page">
                <div class="content">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body mx-4">
                                    <form class="needs-validation" method="post" action="../../php/upload-folder-document.php" enctype="multipart/form-data" novalidate>
                                        <?php
                                        $folder = $_GET['folder'];
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-lg-12 col-sm-12">
                                                ...
                                                <input class="form-control" name="folder_no" type="hidden" value="<?php echo $folder ?>">
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                            <?php
                                $sql = mysqli_query($config, "SELECT * FROM folder_docu_archive");
